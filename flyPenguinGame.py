...
def game():
    ...
    while True:
        ...
        gameOver = isGameOver(horizontal, vertical, game_images['pipeimage'], game_images['flypenguin'], up_pipes, down_pipes)

        if gameOver and health == 0 and collision_immune == True:
        ...
        elif gameOver and health > 0 and collision_immune == False:
...
def game_start(horizontal, vertical):
    ...
    while True:
        for event in pygame.event.get():
            ...
            # If the user presses space key, start the game for them
